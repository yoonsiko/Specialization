...
const = np.array([[-74.87, -0.703029, 108.4773, -42.52157, 5.862788, 0.678565, -76.84376, 158.7163, -74.87310],
...
def enthalpy_heavy(v, T):
    h_vec = v[:,3] + (((v[:,0]*T + v[:,1]/2*T**2*10**(-3) + v[:,2]/3*T**3*10**(-6)) -
                       (v[:,0]*298 + v[:,1]/2*298**2*10**(-3) + v[:,2]/3*298**3*10**(-6)))*8.314 /1000)

    return h_vec



#print(enthalpy(const,400))

# print(enthalpy(const,298))
print(enthalpy_heavy(heavy_const,973))
