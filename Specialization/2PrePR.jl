...
function prePR_model(model, par)
  ...
  @NLconstraint(model, prePR_out_mol[10] - prePR_in_mol[10] == 0) # Energy balance
...
inp = [113.76022309722791, 358.5177276354675, 0.0, 0.0, 1.9483473792214394,
 8.869342547202073, 9.741736896107197, 3.605896642141171, 2.0501267199270368,
  5.379765151581587, 113.76022309722791, 358.5177276354675, 0.0, 0.0, 1.9483473792214394,
  8.869342547202073, 9.741736896107197, 3.605896642141171, 2.0501267199270368, 5.379765151581587,
  381.41, 693.00, 6890.45];
